...
def main():
    ...
    pdf_name = "Plant Pathology - 2011 - Ghini - Diseases in tropical and plantation crops as affected by climate changes  current.pdf"
    ...
    output_name = "ghini_2011_extracted.txt"
